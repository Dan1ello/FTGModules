...
class mQuotesMod(loader.Module):
	...
	strings = {
		...
		"media_type_video": "рџ“№Video",
		"media_type_videomessage": "рџ“№Video message",
		"media_type_voice": "рџЋµVoice message",
		"media_type_audio": "рџЋ§Music: {} - {}",
		"media_type_contact": "рџ‘¤Contact: {}",
		"media_type_poll": "рџ“ЉPoll: ",
		"media_type_quiz": "рџ“ЉQuiz: ",
		"media_type_location": "рџ“ЌLocation",
		"media_type_gif": "рџ–јGIF",
		"media_type_sticker": "Sticker",
		"media_type_file": "рџ’ѕFile",
		"dice_type_dice": "Dice",
		"dice_type_dart": "Dart",
		...
		if dice:
			...
			if reply_message.media.emoticon == "рџЋІ":
				...
				return "{} {}: {}".format(reply_message.media.emoticon,
										  dice_type,
										  dice_text)
			elif reply_message.media.emoticon == "рџЏЂ":
				return "{} {}".format(reply_message.media.emoticon,
